...
class SlidersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create slider" do
    assert_difference('Slider.count') do
      post sliders_url, params: { slider: { buttontext: @slider.buttontext, color: @slider.color, description: @slider.description, link: @slider.link, title: @slider.title } }
    end
  ...
  test "should update slider" do
    patch slider_url(@slider), params: { slider: { buttontext: @slider.buttontext, color: @slider.color, description: @slider.description, link: @slider.link, title: @slider.title } }
