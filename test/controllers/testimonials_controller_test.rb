...
class TestimonialsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create testimonial" do
    assert_difference('Testimonial.count') do
      post testimonials_url, params: { testimonial: { autor: @testimonial.autor, date: @testimonial.date, quote: @testimonial.quote, title: @testimonial.title } }
    end
  ...
  test "should update testimonial" do
    patch testimonial_url(@testimonial), params: { testimonial: { autor: @testimonial.autor, date: @testimonial.date, quote: @testimonial.quote, title: @testimonial.title } }
